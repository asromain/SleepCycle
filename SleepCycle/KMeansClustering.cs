...
namespace SleepCycle
{
    class KMeansClustering
    {
        ...
        public static void calculateCluster()
        {
            ...
            clustering = Cluster(rawData, numClusters); // this is it
        ...
        public static String ShowData(int decimals = 1, bool indices = true, bool newLine = true)
        {
            double[][] data = rawData;
            String result = "";
            for (int i = 0; i < data.Length; ++i)
            {
                if (indices) result += i.ToString().PadLeft(3) + " ";
                for (int j = 0; j < data[i].Length; ++j)
                {
                    if (data[i][j] >= 0.0) result += " ";
                    result += data[i][j].ToString("F" + decimals) + " ";
                }
                result += "\n";
            }
            if (newLine) result += "\n";
        ...
        public static String ShowVector(bool newLine = true)
        {
            int[] vector = clustering;
            String result = "";
        ...
        public static String ShowClustered(int decimals = 1)
        {
            double[][] data = rawData;
            String result = "";
            for (int k = 0; k < numClusters; ++k)
